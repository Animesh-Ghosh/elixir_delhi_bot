defmodule ElixirDelhiBot.ExecutorTest do
  ...
  describe "bot_command?/1" do
    test "returns true when a /start bot command is received" do
      update = %{
        "update_id" => 1,
        "message" => %{
          "chat" => %{"id" => 1},
    ...
    test "returns true when a /help bot command is received" do
      update = %{
        "update_id" => 1,
        "message" => %{
          "chat" => %{"id" => 1},
  ...
  describe "handle_bot_command/1" do
    ...
    test "sends the help message for the /help command" do
      expected_chat_id = 1
